...
public isolated client class Client {
    ...
    resource isolated function delete attachments/[string attachmentGid](map<string|string[]> headers = {}, *DeleteAttachmentQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function delete custom_fields/[string customFieldGid](map<string|string[]> headers = {}, *DeleteCustomFieldQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function delete goals/[string goalGid](map<string|string[]> headers = {}, *DeleteGoalQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function delete memberships/[string membershipGid](map<string|string[]> headers = {}, *DeleteMembershipQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function delete portfolios/[string portfolioGid](map<string|string[]> headers = {}, *DeletePortfolioQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function delete project_briefs/[string projectBriefGid](map<string|string[]> headers = {}, *DeleteProjectBriefQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function delete project_statuses/[string projectStatusGid](map<string|string[]> headers = {}, *DeleteProjectStatusQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function delete project_templates/[string projectTemplateGid](map<string|string[]> headers = {}, *DeleteProjectTemplateQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function delete projects/[string projectGid](map<string|string[]> headers = {}, *DeleteProjectQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function delete sections/[string sectionGid](map<string|string[]> headers = {}, *DeleteSectionQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function delete status_updates/[string statusUpdateGid](map<string|string[]> headers = {}, *DeleteStatusQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function delete stories/[string storyGid](map<string|string[]> headers = {}, *DeleteStoryQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function delete tags/[string tagGid](map<string|string[]> headers = {}, *DeleteTagQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function delete task_templates/[string taskTemplateGid](map<string|string[]> headers = {}, *DeleteTaskTemplateQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function delete tasks/[string taskGid](map<string|string[]> headers = {}, *DeleteTaskQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function delete time_tracking_entries/[string timeTrackingEntryGid](map<string|string[]> headers = {}, *DeleteTimeTrackingEntryQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function delete webhooks/[string webhookGid](map<string|string[]> headers = {}, *DeleteWebhookQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function get attachments/[string attachmentGid](map<string|string[]> headers = {}, *GetAttachmentQueries queries) returns InlineResponse200|error {
        string resourcePath = string `/attachments/${getEncodedUri(attachmentGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        return self.clientEp->get(resourcePath, headers);
    ...
    resource isolated function get custom_fields/[string customFieldGid](map<string|string[]> headers = {}, *GetCustomFieldQueries queries) returns InlineResponse201|error {
        string resourcePath = string `/custom_fields/${getEncodedUri(customFieldGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        return self.clientEp->get(resourcePath, headers);
    ...
    resource isolated function get goal_relationships/[string goalRelationshipGid](map<string|string[]> headers = {}, *GetGoalRelationshipQueries queries) returns InlineResponse2008|error {
    ...
    resource isolated function get goals/[string goalGid](map<string|string[]> headers = {}, *GetGoalQueries queries) returns InlineResponse20010|error {
        string resourcePath = string `/goals/${getEncodedUri(goalGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        return self.clientEp->get(resourcePath, headers);
    ...
    resource isolated function get goals/[string goalGid]/parentGoals(map<string|string[]> headers = {}, *GetParentGoalsForGoalQueries queries) returns InlineResponse20012|error {
    ...
    resource isolated function get jobs/[string jobGid](map<string|string[]> headers = {}, *GetJobQueries queries) returns InlineResponse20013|error {
    ...
    resource isolated function get memberships/[string membershipGid](map<string|string[]> headers = {}, *GetMembershipQueries queries) returns InlineResponse20015|error {
        string resourcePath = string `/memberships/${getEncodedUri(membershipGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        return self.clientEp->get(resourcePath, headers);
    ...
    resource isolated function get organization_exports/[string organizationExportGid](map<string|string[]> headers = {}, *GetOrganizationExportQueries queries) returns InlineResponse2013|error {
    ...
    resource isolated function get portfolio_memberships/[string portfolioMembershipGid](map<string|string[]> headers = {}, *GetPortfolioMembershipQueries queries) returns InlineResponse20017|error {
    ...
    resource isolated function get portfolios/[string portfolioGid](map<string|string[]> headers = {}, *GetPortfolioQueries queries) returns InlineResponse2014|error {
        string resourcePath = string `/portfolios/${getEncodedUri(portfolioGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        return self.clientEp->get(resourcePath, headers);
    ...
    resource isolated function get portfolios/[string portfolioGid]/custom_field_settings(map<string|string[]> headers = {}, *GetCustomFieldSettingsForPortfolioQueries queries) returns InlineResponse2005|error {
    ...
    resource isolated function get portfolios/[string portfolioGid]/items(map<string|string[]> headers = {}, *GetItemsForPortfolioQueries queries) returns InlineResponse20019|error {
    ...
    resource isolated function get portfolios/[string portfolioGid]/portfolio_memberships(map<string|string[]> headers = {}, *GetPortfolioMembershipsForPortfolioQueries queries) returns InlineResponse20016|error {
    ...
    resource isolated function get project_briefs/[string projectBriefGid](map<string|string[]> headers = {}, *GetProjectBriefQueries queries) returns InlineResponse20021|error {
        string resourcePath = string `/project_briefs/${getEncodedUri(projectBriefGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        return self.clientEp->get(resourcePath, headers);
    ...
    resource isolated function get project_memberships/[string projectMembershipGid](map<string|string[]> headers = {}, *GetProjectMembershipQueries queries) returns InlineResponse20022|error {
    ...
    resource isolated function get project_statuses/[string projectStatusGid](map<string|string[]> headers = {}, *GetProjectStatusQueries queries) returns InlineResponse20024|error {
        string resourcePath = string `/project_statuses/${getEncodedUri(projectStatusGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        return self.clientEp->get(resourcePath, headers);
    ...
    resource isolated function get project_templates/[string projectTemplateGid](map<string|string[]> headers = {}, *GetProjectTemplateQueries queries) returns InlineResponse20026|error {
        string resourcePath = string `/project_templates/${getEncodedUri(projectTemplateGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        return self.clientEp->get(resourcePath, headers);
    ...
    resource isolated function get projects/[string projectGid](map<string|string[]> headers = {}, *GetProjectQueries queries) returns InlineResponse2015|error {
        string resourcePath = string `/projects/${getEncodedUri(projectGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        return self.clientEp->get(resourcePath, headers);
    ...
    resource isolated function get projects/[string projectGid]/custom_field_settings(map<string|string[]> headers = {}, *GetCustomFieldSettingsForProjectQueries queries) returns InlineResponse2005|error {
    ...
    resource isolated function get projects/[string projectGid]/project_memberships(map<string|string[]> headers = {}, *GetProjectMembershipsForProjectQueries queries) returns InlineResponse20023|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Successfully retrieved the specified project's status updates. 
    resource isolated function get projects/[string projectGid]/project_statuses(map<string|string[]> headers = {}, *GetProjectStatusesForProjectQueries queries) returns InlineResponse20025|error {
    ...
    resource isolated function get projects/[string projectGid]/sections(map<string|string[]> headers = {}, *GetSectionsForProjectQueries queries) returns InlineResponse20031|error {
    ...
    resource isolated function get projects/[string projectGid]/task_counts(map<string|string[]> headers = {}, *GetTaskCountsForProjectQueries queries) returns InlineResponse20028|error {
    ...
    resource isolated function get projects/[string projectGid]/tasks(map<string|string[]> headers = {}, *GetTasksForProjectQueries queries) returns InlineResponse20039|error {
    ...
    resource isolated function get sections/[string sectionGid](map<string|string[]> headers = {}, *GetSectionQueries queries) returns InlineResponse20030|error {
        string resourcePath = string `/sections/${getEncodedUri(sectionGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        return self.clientEp->get(resourcePath, headers);
    ...
    resource isolated function get sections/[string sectionGid]/tasks(map<string|string[]> headers = {}, *GetTasksForSectionQueries queries) returns InlineResponse20039|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Successfully retrieved the specified object's status updates. 
    resource isolated function get status_updates/[string statusUpdateGid](map<string|string[]> headers = {}, *GetStatusQueries queries) returns InlineResponse20032|error {
        string resourcePath = string `/status_updates/${getEncodedUri(statusUpdateGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        return self.clientEp->get(resourcePath, headers);
    ...
    resource isolated function get stories/[string storyGid](map<string|string[]> headers = {}, *GetStoryQueries queries) returns InlineResponse20034|error {
        string resourcePath = string `/stories/${getEncodedUri(storyGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        return self.clientEp->get(resourcePath, headers);
    ...
    resource isolated function get tags/[string tagGid](map<string|string[]> headers = {}, *GetTagQueries queries) returns InlineResponse2016|error {
        string resourcePath = string `/tags/${getEncodedUri(tagGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        return self.clientEp->get(resourcePath, headers);
    ...
    resource isolated function get tags/[string tagGid]/tasks(map<string|string[]> headers = {}, *GetTasksForTagQueries queries) returns InlineResponse20039|error {
    ...
    resource isolated function get task_templates/[string taskTemplateGid](map<string|string[]> headers = {}, *GetTaskTemplateQueries queries) returns InlineResponse20038|error {
        string resourcePath = string `/task_templates/${getEncodedUri(taskTemplateGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        return self.clientEp->get(resourcePath, headers);
    ...
    resource isolated function get tasks/[string taskGid](map<string|string[]> headers = {}, *GetTaskQueries queries) returns InlineResponse2017|error {
        string resourcePath = string `/tasks/${getEncodedUri(taskGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        return self.clientEp->get(resourcePath, headers);
    ...
    resource isolated function get tasks/[string taskGid]/dependencies(map<string|string[]> headers = {}, *GetDependenciesForTaskQueries queries) returns InlineResponse20039|error {
    ...
    resource isolated function get tasks/[string taskGid]/dependents(map<string|string[]> headers = {}, *GetDependentsForTaskQueries queries) returns InlineResponse20039|error {
    ...
    resource isolated function get tasks/[string taskGid]/projects(map<string|string[]> headers = {}, *GetProjectsForTaskQueries queries) returns InlineResponse20019|error {
    ...
    resource isolated function get tasks/[string taskGid]/stories(map<string|string[]> headers = {}, *GetStoriesForTaskQueries queries) returns InlineResponse20035|error {
    ...
    resource isolated function get tasks/[string taskGid]/subtasks(map<string|string[]> headers = {}, *GetSubtasksForTaskQueries queries) returns InlineResponse20039|error {
    ...
    resource isolated function get tasks/[string taskGid]/tags(map<string|string[]> headers = {}, *GetTagsForTaskQueries queries) returns InlineResponse20036|error {
    ...
    resource isolated function get tasks/[string taskGid]/time_tracking_entries(map<string|string[]> headers = {}, *GetTimeTrackingEntriesForTaskQueries queries) returns InlineResponse20046|error {
    ...
    resource isolated function get team_memberships/[string teamMembershipGid](map<string|string[]> headers = {}, *GetTeamMembershipQueries queries) returns InlineResponse20041|error {
    ...
    resource isolated function get teams/[string teamGid](map<string|string[]> headers = {}, *GetTeamQueries queries) returns InlineResponse2018|error {
    ...
    resource isolated function get teams/[string teamGid]/project_templates(map<string|string[]> headers = {}, *GetProjectTemplatesForTeamQueries queries) returns InlineResponse20027|error {
    ...
    resource isolated function get teams/[string teamGid]/projects(map<string|string[]> headers = {}, *GetProjectsForTeamQueries queries) returns InlineResponse20019|error {
    ...
    resource isolated function get teams/[string teamGid]/team_memberships(map<string|string[]> headers = {}, *GetTeamMembershipsForTeamQueries queries) returns InlineResponse20042|error {
    ...
    resource isolated function get teams/[string teamGid]/users(map<string|string[]> headers = {}, *GetUsersForTeamQueries queries) returns InlineResponse20052|error {
    ...
    resource isolated function get time_periods/[string timePeriodGid](map<string|string[]> headers = {}, *GetTimePeriodQueries queries) returns InlineResponse20044|error {
    ...
    resource isolated function get time_tracking_entries/[string timeTrackingEntryGid](map<string|string[]> headers = {}, *GetTimeTrackingEntryQueries queries) returns InlineResponse2019|error {
        string resourcePath = string `/time_tracking_entries/${getEncodedUri(timeTrackingEntryGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        return self.clientEp->get(resourcePath, headers);
    ...
    resource isolated function get user_task_lists/[string userTaskListGid](map<string|string[]> headers = {}, *GetUserTaskListQueries queries) returns InlineResponse20048|error {
    ...
    resource isolated function get user_task_lists/[string userTaskListGid]/tasks(map<string|string[]> headers = {}, *GetTasksForUserTaskListQueries queries) returns InlineResponse20039|error {
    ...
    resource isolated function get users/[string userGid](map<string|string[]> headers = {}, *GetUserQueries queries) returns InlineResponse20050|error {
    ...
    resource isolated function get users/[string userGid]/favorites(map<string|string[]> headers = {}, *GetFavoritesForUserQueries queries) returns InlineResponse20051|error {
    ...
    resource isolated function get users/[string userGid]/team_memberships(map<string|string[]> headers = {}, *GetTeamMembershipsForUserQueries queries) returns InlineResponse20042|error {
    ...
    resource isolated function get users/[string userGid]/teams(map<string|string[]> headers = {}, *GetTeamsForUserQueries queries) returns InlineResponse20043|error {
    ...
    resource isolated function get users/[string userGid]/user_task_list(map<string|string[]> headers = {}, *GetUserTaskListForUserQueries queries) returns InlineResponse20048|error {
    ...
    resource isolated function get users/[string userGid]/workspace_memberships(map<string|string[]> headers = {}, *GetWorkspaceMembershipsForUserQueries queries) returns InlineResponse20055|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Successfully retrieved the requested webhook. 
    resource isolated function get webhooks/[string webhookGid](map<string|string[]> headers = {}, *GetWebhookQueries queries) returns InlineResponse20110|error {
        string resourcePath = string `/webhooks/${getEncodedUri(webhookGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        return self.clientEp->get(resourcePath, headers);
    ...
    resource isolated function get workspace_memberships/[string workspaceMembershipGid](map<string|string[]> headers = {}, *GetWorkspaceMembershipQueries queries) returns InlineResponse20054|error {
    ...
    resource isolated function get workspaces/[string workspaceGid](map<string|string[]> headers = {}, *GetWorkspaceQueries queries) returns InlineResponse20057|error {
    ...
    resource isolated function get workspaces/[string workspaceGid]/audit_log_events(map<string|string[]> headers = {}, *GetAuditLogEventsQueries queries) returns InlineResponse2003|error {
    ...
    resource isolated function get workspaces/[string workspaceGid]/custom_fields(map<string|string[]> headers = {}, *GetCustomFieldsForWorkspaceQueries queries) returns InlineResponse2006|error {
    ...
    resource isolated function get workspaces/[string workspaceGid]/projects(map<string|string[]> headers = {}, *GetProjectsForWorkspaceQueries queries) returns InlineResponse20019|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Successfully retrieved the specified set of tags. 
    resource isolated function get workspaces/[string workspaceGid]/tags(map<string|string[]> headers = {}, *GetTagsForWorkspaceQueries queries) returns InlineResponse20036|error {
    ...
    resource isolated function get workspaces/[string workspaceGid]/tasks/custom_id/[string customId](map<string|string[]> headers = {}) returns InlineResponse2017|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Successfully retrieved the section's tasks. 
    resource isolated function get workspaces/[string workspaceGid]/tasks/search(map<string|string[]> headers = {}, *SearchTasksForWorkspaceQueries queries) returns InlineResponse20040|error {
    ...
    resource isolated function get workspaces/[string workspaceGid]/teams(map<string|string[]> headers = {}, *GetTeamsForWorkspaceQueries queries) returns InlineResponse20043|error {
    ...
    resource isolated function get workspaces/[string workspaceGid]/typeahead(map<string|string[]> headers = {}, *TypeaheadForWorkspaceQueries queries) returns InlineResponse20047|error {
    ...
    resource isolated function get workspaces/[string workspaceGid]/users(map<string|string[]> headers = {}, *GetUsersForWorkspaceQueries queries) returns InlineResponse20052|error {
    ...
    resource isolated function get workspaces/[string workspaceGid]/workspace_memberships(map<string|string[]> headers = {}, *GetWorkspaceMembershipsForWorkspaceQueries queries) returns InlineResponse20055|error {
    ...
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    # + request - The file you want to upload. 
    ...
    resource isolated function post custom_fields/[string customFieldGid]/enum_options(CustomFieldGidEnumOptionsBody payload, map<string|string[]> headers = {}, *CreateEnumOptionForCustomFieldQueries queries) returns InlineResponse2011|error {
    ...
    resource isolated function post custom_fields/[string customFieldGid]/enum_options/insert(EnumOptionsInsertBody payload, map<string|string[]> headers = {}, *InsertEnumOptionForCustomFieldQueries queries) returns InlineResponse2011|error {
    ...
    resource isolated function post goals/[string goalGid]/addFollowers(GoalGidAddFollowersBody payload, map<string|string[]> headers = {}, *AddFollowersQueries queries) returns InlineResponse20010|error {
    ...
    resource isolated function post goals/[string goalGid]/addSupportingRelationship(GoalGidAddSupportingRelationshipBody payload, map<string|string[]> headers = {}, *AddSupportingRelationshipQueries queries) returns InlineResponse2008|error {
    ...
    resource isolated function post goals/[string goalGid]/removeFollowers(GoalGidRemoveFollowersBody payload, map<string|string[]> headers = {}, *RemoveFollowersQueries queries) returns InlineResponse20010|error {
    ...
    resource isolated function post goals/[string goalGid]/removeSupportingRelationship(GoalGidRemoveSupportingRelationshipBody payload, map<string|string[]> headers = {}, *RemoveSupportingRelationshipQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function post goals/[string goalGid]/setMetric(GoalGidSetMetricBody payload, map<string|string[]> headers = {}, *CreateGoalMetricQueries queries) returns InlineResponse20010|error {
    ...
    resource isolated function post goals/[string goalGid]/setMetricCurrentValue(GoalGidSetMetricCurrentValueBody payload, map<string|string[]> headers = {}, *UpdateGoalMetricQueries queries) returns InlineResponse20010|error {
    ...
    resource isolated function post portfolios/[string portfolioGid]/addCustomFieldSetting(PortfolioGidAddCustomFieldSettingBody payload, map<string|string[]> headers = {}, *AddCustomFieldSettingForPortfolioQueries queries) returns InlineResponse20020|error {
    ...
    resource isolated function post portfolios/[string portfolioGid]/addItem(PortfolioGidAddItemBody payload, map<string|string[]> headers = {}, *AddItemForPortfolioQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function post portfolios/[string portfolioGid]/addMembers(PortfolioGidAddMembersBody payload, map<string|string[]> headers = {}, *AddMembersForPortfolioQueries queries) returns InlineResponse2014|error {
    ...
    resource isolated function post portfolios/[string portfolioGid]/removeCustomFieldSetting(PortfolioGidRemoveCustomFieldSettingBody payload, map<string|string[]> headers = {}, *RemoveCustomFieldSettingForPortfolioQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function post portfolios/[string portfolioGid]/removeItem(PortfolioGidRemoveItemBody payload, map<string|string[]> headers = {}, *RemoveItemForPortfolioQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function post portfolios/[string portfolioGid]/removeMembers(PortfolioGidRemoveMembersBody payload, map<string|string[]> headers = {}, *RemoveMembersForPortfolioQueries queries) returns InlineResponse2014|error {
    ...
    resource isolated function post project_templates/[string projectTemplateGid]/instantiateProject(ProjectTemplateGidInstantiateProjectBody payload, map<string|string[]> headers = {}, *InstantiateProjectQueries queries) returns InlineResponse20013|error {
    ...
    resource isolated function post projects/[string projectGid]/addCustomFieldSetting(ProjectGidAddCustomFieldSettingBody payload, map<string|string[]> headers = {}, *AddCustomFieldSettingForProjectQueries queries) returns InlineResponse20020|error {
    ...
    resource isolated function post projects/[string projectGid]/addFollowers(ProjectGidAddFollowersBody payload, map<string|string[]> headers = {}, *AddFollowersForProjectQueries queries) returns InlineResponse2015|error {
    ...
    resource isolated function post projects/[string projectGid]/addMembers(ProjectGidAddMembersBody payload, map<string|string[]> headers = {}, *AddMembersForProjectQueries queries) returns InlineResponse2015|error {
    ...
    resource isolated function post projects/[string projectGid]/duplicate(ProjectGidDuplicateBody payload, map<string|string[]> headers = {}, *DuplicateProjectQueries queries) returns InlineResponse20013|error {
    ...
    resource isolated function post projects/[string projectGid]/project_briefs(ProjectGidProjectBriefsBody payload, map<string|string[]> headers = {}, *CreateProjectBriefQueries queries) returns InlineResponse20021|error {
    ...
    resource isolated function post projects/[string projectGid]/project_statuses(ProjectGidProjectStatusesBody payload, map<string|string[]> headers = {}, *CreateProjectStatusForProjectQueries queries) returns InlineResponse20024|error {
        string resourcePath = string `/projects/${getEncodedUri(projectGid)}/project_statuses`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        http:Request request = new;
    ...
    resource isolated function post projects/[string projectGid]/removeCustomFieldSetting(ProjectGidRemoveCustomFieldSettingBody payload, map<string|string[]> headers = {}, *RemoveCustomFieldSettingForProjectQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function post projects/[string projectGid]/removeFollowers(ProjectGidRemoveFollowersBody payload, map<string|string[]> headers = {}, *RemoveFollowersForProjectQueries queries) returns InlineResponse2015|error {
    ...
    resource isolated function post projects/[string projectGid]/removeMembers(ProjectGidRemoveMembersBody payload, map<string|string[]> headers = {}, *RemoveMembersForProjectQueries queries) returns InlineResponse2015|error {
    ...
    resource isolated function post projects/[string projectGid]/saveAsTemplate(ProjectGidSaveAsTemplateBody payload, map<string|string[]> headers = {}, *ProjectSaveAsTemplateQueries queries) returns InlineResponse20013|error {
    ...
    resource isolated function post projects/[string projectGid]/sections(ProjectGidSectionsBody payload, map<string|string[]> headers = {}, *CreateSectionForProjectQueries queries) returns InlineResponse20030|error {
        string resourcePath = string `/projects/${getEncodedUri(projectGid)}/sections`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        http:Request request = new;
    ...
    resource isolated function post projects/[string projectGid]/sections/insert(SectionsInsertBody payload, map<string|string[]> headers = {}, *InsertSectionForProjectQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function post rule_triggers/[string ruleTriggerGid]/run(RuleTriggerGidRunBody payload, map<string|string[]> headers = {}) returns InlineResponse20029|error {
    ...
    resource isolated function post sections/[string sectionGid]/addTask(SectionGidAddTaskBody payload, map<string|string[]> headers = {}, *AddTaskForSectionQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function post task_templates/[string taskTemplateGid]/instantiateTask(TaskTemplateGidInstantiateTaskBody payload, map<string|string[]> headers = {}, *InstantiateTaskQueries queries) returns InlineResponse20013|error {
    ...
    resource isolated function post tasks/[string taskGid]/addDependencies(TaskGidAddDependenciesBody payload, map<string|string[]> headers = {}, *AddDependenciesForTaskQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function post tasks/[string taskGid]/addDependents(TaskGidAddDependentsBody payload, map<string|string[]> headers = {}, *AddDependentsForTaskQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function post tasks/[string taskGid]/addFollowers(TaskGidAddFollowersBody payload, map<string|string[]> headers = {}, *AddFollowersForTaskQueries queries) returns InlineResponse2017|error {
    ...
    resource isolated function post tasks/[string taskGid]/addProject(TaskGidAddProjectBody payload, map<string|string[]> headers = {}, *AddProjectForTaskQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function post tasks/[string taskGid]/addTag(TaskGidAddTagBody payload, map<string|string[]> headers = {}, *AddTagForTaskQueries queries) returns InlineResponse2001|error {
    ...
    # + return - Successfully created the job to handle duplication. 
    resource isolated function post tasks/[string taskGid]/duplicate(TaskGidDuplicateBody payload, map<string|string[]> headers = {}, *DuplicateTaskQueries queries) returns InlineResponse20013|error {
    ...
    resource isolated function post tasks/[string taskGid]/removeDependencies(TaskGidRemoveDependenciesBody payload, map<string|string[]> headers = {}, *RemoveDependenciesForTaskQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function post tasks/[string taskGid]/removeDependents(TaskGidRemoveDependentsBody payload, map<string|string[]> headers = {}, *RemoveDependentsForTaskQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function post tasks/[string taskGid]/removeFollowers(TaskGidRemoveFollowersBody payload, map<string|string[]> headers = {}, *RemoveFollowerForTaskQueries queries) returns InlineResponse2017|error {
    ...
    resource isolated function post tasks/[string taskGid]/removeProject(TaskGidRemoveProjectBody payload, map<string|string[]> headers = {}, *RemoveProjectForTaskQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function post tasks/[string taskGid]/removeTag(TaskGidRemoveTagBody payload, map<string|string[]> headers = {}, *RemoveTagForTaskQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function post tasks/[string taskGid]/setParent(TaskGidSetParentBody payload, map<string|string[]> headers = {}, *SetParentForTaskQueries queries) returns InlineResponse2017|error {
    ...
    # + return - Successfully created a new story. 
    resource isolated function post tasks/[string taskGid]/stories(TaskGidStoriesBody payload, map<string|string[]> headers = {}, *CreateStoryForTaskQueries queries) returns InlineResponse20034|error {
        string resourcePath = string `/tasks/${getEncodedUri(taskGid)}/stories`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        http:Request request = new;
    ...
    resource isolated function post tasks/[string taskGid]/subtasks(TaskGidSubtasksBody payload, map<string|string[]> headers = {}, *CreateSubtaskForTaskQueries queries) returns InlineResponse2017|error {
        string resourcePath = string `/tasks/${getEncodedUri(taskGid)}/subtasks`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        http:Request request = new;
    ...
    resource isolated function post tasks/[string taskGid]/time_tracking_entries(TaskGidTimeTrackingEntriesBody payload, map<string|string[]> headers = {}, *CreateTimeTrackingEntryQueries queries) returns InlineResponse2019|error {
        string resourcePath = string `/tasks/${getEncodedUri(taskGid)}/time_tracking_entries`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        http:Request request = new;
    ...
    resource isolated function post teams/[string teamGid]/addUser(TeamGidAddUserBody payload, map<string|string[]> headers = {}, *AddUserForTeamQueries queries) returns InlineResponse20041|error {
    ...
    resource isolated function post teams/[string teamGid]/projects(TeamGidProjectsBody payload, map<string|string[]> headers = {}, *CreateProjectForTeamQueries queries) returns InlineResponse2015|error {
        string resourcePath = string `/teams/${getEncodedUri(teamGid)}/projects`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        http:Request request = new;
    ...
    resource isolated function post teams/[string teamGid]/removeUser(TeamGidRemoveUserBody payload, map<string|string[]> headers = {}, *RemoveUserForTeamQueries queries) returns InlineResponse2001|error {
    ...
    resource isolated function post workspaces/[string workspaceGid]/addUser(WorkspaceGidAddUserBody payload, map<string|string[]> headers = {}, *AddUserForWorkspaceQueries queries) returns InlineResponse20058|error {
    ...
    resource isolated function post workspaces/[string workspaceGid]/projects(WorkspaceGidProjectsBody payload, map<string|string[]> headers = {}, *CreateProjectForWorkspaceQueries queries) returns InlineResponse2015|error {
        string resourcePath = string `/workspaces/${getEncodedUri(workspaceGid)}/projects`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        http:Request request = new;
    ...
    resource isolated function post workspaces/[string workspaceGid]/removeUser(WorkspaceGidRemoveUserBody payload, map<string|string[]> headers = {}, *RemoveUserForWorkspaceQueries queries) returns InlineResponse2001|error {
    ...
    # + payload - The tag to create. 
    # + return - Successfully created the newly specified tag. 
    resource isolated function post workspaces/[string workspaceGid]/tags(WorkspaceGidTagsBody payload, map<string|string[]> headers = {}, *CreateTagForWorkspaceQueries queries) returns InlineResponse2016|error {
        string resourcePath = string `/workspaces/${getEncodedUri(workspaceGid)}/tags`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        http:Request request = new;
    ...
    resource isolated function put custom_fields/[string customFieldGid](CustomFieldscustomFieldGidBody payload, map<string|string[]> headers = {}, *UpdateCustomFieldQueries queries) returns InlineResponse201|error {
        string resourcePath = string `/custom_fields/${getEncodedUri(customFieldGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        http:Request request = new;
    ...
    resource isolated function put enum_options/[string enumOptionGid](EnumOptionsenumOptionGidBody payload, map<string|string[]> headers = {}, *UpdateEnumOptionQueries queries) returns InlineResponse2011|error {
    ...
    resource isolated function put goal_relationships/[string goalRelationshipGid](GoalRelationshipsgoalRelationshipGidBody payload, map<string|string[]> headers = {}, *UpdateGoalRelationshipQueries queries) returns InlineResponse2008|error {
        string resourcePath = string `/goal_relationships/${getEncodedUri(goalRelationshipGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        http:Request request = new;
    ...
    resource isolated function put goals/[string goalGid](GoalsgoalGidBody payload, map<string|string[]> headers = {}, *UpdateGoalQueries queries) returns InlineResponse20010|error {
        string resourcePath = string `/goals/${getEncodedUri(goalGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        http:Request request = new;
    ...
    resource isolated function put memberships/[string membershipGid](MembershipsmembershipGidBody payload, map<string|string[]> headers = {}, *UpdateMembershipQueries queries) returns InlineResponse2012|error {
        string resourcePath = string `/memberships/${getEncodedUri(membershipGid)}`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        http:Request request = new;
        json jsonBody = payload.toJson();
    ...
    resource isolated function put portfolios/[string portfolioGid](PortfoliosportfolioGidBody payload, map<string|string[]> headers = {}, *UpdatePortfolioQueries queries) returns InlineResponse2014|error {
        string resourcePath = string `/portfolios/${getEncodedUri(portfolioGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        http:Request request = new;
    ...
    resource isolated function put project_briefs/[string projectBriefGid](ProjectBriefsprojectBriefGidBody payload, map<string|string[]> headers = {}, *UpdateProjectBriefQueries queries) returns InlineResponse20021|error {
        string resourcePath = string `/project_briefs/${getEncodedUri(projectBriefGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        http:Request request = new;
    ...
    resource isolated function put projects/[string projectGid](ProjectsprojectGidBody payload, map<string|string[]> headers = {}, *UpdateProjectQueries queries) returns InlineResponse2015|error {
        string resourcePath = string `/projects/${getEncodedUri(projectGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        http:Request request = new;
    ...
    resource isolated function put sections/[string sectionGid](SectionssectionGidBody payload, map<string|string[]> headers = {}, *UpdateSectionQueries queries) returns InlineResponse20030|error {
        string resourcePath = string `/sections/${getEncodedUri(sectionGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        http:Request request = new;
    ...
    # + return - Successfully retrieved the specified story. 
    resource isolated function put stories/[string storyGid](StoriesstoryGidBody payload, map<string|string[]> headers = {}, *UpdateStoryQueries queries) returns InlineResponse20034|error {
        string resourcePath = string `/stories/${getEncodedUri(storyGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        http:Request request = new;
    ...
    resource isolated function put tags/[string tagGid](map<string|string[]> headers = {}, *UpdateTagQueries queries) returns InlineResponse2016|error {
        string resourcePath = string `/tags/${getEncodedUri(tagGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        http:Request request = new;
    ...
    resource isolated function put tasks/[string taskGid](TaskstaskGidBody payload, map<string|string[]> headers = {}, *UpdateTaskQueries queries) returns InlineResponse2017|error {
        string resourcePath = string `/tasks/${getEncodedUri(taskGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        http:Request request = new;
    ...
    resource isolated function put teams/[string teamGid](TeamsteamGidBody payload, map<string|string[]> headers = {}, *UpdateTeamQueries queries) returns InlineResponse2018|error {
        string resourcePath = string `/teams/${getEncodedUri(teamGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        http:Request request = new;
    ...
    resource isolated function put time_tracking_entries/[string timeTrackingEntryGid](TimeTrackingEntriestimeTrackingEntryGidBody payload, map<string|string[]> headers = {}, *UpdateTimeTrackingEntryQueries queries) returns InlineResponse2019|error {
        string resourcePath = string `/time_tracking_entries/${getEncodedUri(timeTrackingEntryGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        http:Request request = new;
    ...
    resource isolated function put webhooks/[string webhookGid](WebhookswebhookGidBody payload, map<string|string[]> headers = {}, *UpdateWebhookQueries queries) returns InlineResponse20110|error {
        string resourcePath = string `/webhooks/${getEncodedUri(webhookGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        http:Request request = new;
    ...
    resource isolated function put workspaces/[string workspaceGid](WorkspacesworkspaceGidBody payload, map<string|string[]> headers = {}, *UpdateWorkspaceQueries queries) returns InlineResponse20057|error {
        string resourcePath = string `/workspaces/${getEncodedUri(workspaceGid)}`;
        map<Encoding> queryParamEncoding = {"opt_fields": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        http:Request request = new;
